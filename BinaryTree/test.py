...
print("sum of left leaves".center(40, '='))
tree_sum_of_left_leaves = BinaryTree()
tree_sum_of_left_leaves.root = TreeNode(3)
tree_sum_of_left_leaves.left_insert(tree_sum_of_left_leaves.root, 9)
tree_sum_of_left_leaves.right_insert(tree_sum_of_left_leaves.root, 20)
tree_sum_of_left_leaves.left_insert(tree_sum_of_left_leaves.root.right, 15)
tree_sum_of_left_leaves.right_insert(tree_sum_of_left_leaves.root.right, 7)
sum_left_leaves = Solutions().sum_of_left_leaves(tree_sum_of_left_leaves.root)
print(f'sum of left leaves = {sum_left_leaves}')
